...
Python (`pip install bourdon`) is the **oracle**. The `@bourdon/*` TypeScript mirror is conformant iff it
...
```ts
import { loadRedactionBattery, assembleSecret } from "@bourdon/conformance";
